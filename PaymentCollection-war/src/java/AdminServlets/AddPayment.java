        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session != null) {
                ...
                if (getAdmin.equals("admin")) {
                    ...
                    String updatepaymentdetailsBtn = request.getParameter("updatepaymentdetails");
                    String submitBtn = request.getParameter("submit");

                    if (addBtn != null) {
                        response.sendRedirect("addpayment.jsp");
                    } else if (updatepaymentdetailsBtn != null) {
                        Long getID = Long.parseLong(updatepaymentdetailsBtn);
